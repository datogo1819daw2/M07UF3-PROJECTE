...
<div class="container">
  ...
  @method('PUT')
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="nomPrograma" value="{{$programa->nomPrograma}}" required><br>
      <label for="descPrograma">Descripció programa:</label>
      <input type="text" class="form-control" name="descPrograma" value="{{$programa->descPrograma}}" required><br>
