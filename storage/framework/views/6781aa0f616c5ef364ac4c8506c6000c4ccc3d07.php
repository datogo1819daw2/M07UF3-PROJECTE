...
<div class="container">
	...
	<div class="col-md-12">
		...
		<table class="table">
			...
			<tbody>
				<tr>
					<th scope="row"><?php echo e($canal->id); ?></th>
					<td><?php echo e($canal->nomCanal); ?></td>
					<td><img src="<?php echo e(URL::to('/')); ?>/images/<?php echo e($canal -> logotipCanal); ?>" class="rounded" width="70" /></td>
					<td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\M07UF3-PROJECTE-master\resources\views/canals/indexCanal.blade.php ENDPATH**/ ?>